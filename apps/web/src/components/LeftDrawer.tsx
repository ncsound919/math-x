      ...
      <div style={{ padding: '16px 14px', overflowY: 'auto', flex: 1 }}>
        ...
        <div style={{ marginBottom: 18 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
            <div style={{ fontSize: '0.6rem', color: 'var(--text-faint)', letterSpacing: '0.18em' }}>⧗ SESSIONS</div>
            <button
        ...
        {/* Folder drop zone */}
        <div style={{ fontSize: '0.6rem', color: 'var(--text-faint)', letterSpacing: '0.18em', marginBottom: 10 }}>◫ FILE INTELLIGENCE</div>
        <div
        ...
        >
          ...
          <div style={{ fontSize: '0.6rem', marginTop: 3, color: 'var(--text-faint)' }}>PDF · CSV · JSON · IMG · CODE</div>
        </div>
        ...
        {ingestedFiles.length > 0 && (
          <div>
            <div style={{ fontSize: '0.58rem', color: 'var(--text-faint)', letterSpacing: '0.12em', marginBottom: 8 }}>LOADED ({ingestedFiles.length})</div>
        ...
        <div style={{ marginTop: 20, padding: '10px', background: 'var(--bg2)', borderRadius: 6, border: '1px solid var(--border-dim)' }}>
